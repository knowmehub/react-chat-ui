...
var ChatBubble = (function (_super) {
    ...
    ChatBubble.prototype.render = function () {
        ...
        var chatBubbleStyles = this.props.message.id === 0
            ? __assign(__assign(__assign({}, styles_1.default.chatbubble), bubblesCentered ? {} : styles_1.default.chatbubbleOrientationNormal), userBubble) : __assign(__assign(__assign(__assign({}, styles_1.default.chatbubble), styles_1.default.recipientChatbubble), bubblesCentered
            ? {}
            : styles_1.default.recipientChatbubbleOrientationNormal), chatbubble);
